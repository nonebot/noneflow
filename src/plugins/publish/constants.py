...
PLUGIN_STRING_PATTERN_LIST = [
    (PLUGIN_NAME_STRING, PLUGIN_NAME_PATTERN),
    (PLUGIN_DESC_STRING, PLUGIN_DESC_PATTERN),
    (PLUGIN_HOMEPAGE_STRING, PLUGIN_HOMEPAGE_PATTERN),
    (PLUGIN_TYPE_STRING, PLUGIN_TYPE_PATTERN),
    (PLUGIN_SUPPORTED_ADAPTERS_STRING, PLUGIN_SUPPORTED_ADAPTERS_PATTERN),
]
# 协议
